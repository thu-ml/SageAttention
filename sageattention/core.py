    ...
    **kwargs: Any,
    ...
    if headdim == 96:
        ...
        if is_causal:
            ...
            return attn_h96_false(q_int8, k_int8, v, q_scale, k_scale, tensor_layout=tensor_layout, attn_mask=attn_mask, output_dtype=dtype)
    ...
    if is_causal:
        ...
        if attn_mask is not None:
            ...
            try:
                ...
                raise AssertionError(f"attn_mask shape {attn_mask.shape} cannot be broadcast to {target_shape}")
        o = attn_false(q_int8, k_int8, v, q_scale, k_scale, tensor_layout=tensor_layout, attn_mask=attn_mask, output_dtype=dtype)
