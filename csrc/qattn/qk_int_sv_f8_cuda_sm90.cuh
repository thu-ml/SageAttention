  ...
  cudaStream_t stream)
{
  ...
  auto* kernel = qk_int8_sv_f8_attn_kernel<CTA_Q, CTA_K, NUM_THREADS, head_dim, static_cast<QuantGranularity>(qk_quant_gran), static_cast<QuantGranularity>(qk_quant_gran), DTypeOut, mask_mode, return_lse, fuse_v_scale>;
