...
header = '// this file is automatically generated by running `python autogen_accum_f16+f32.py`\n#include "../qk_int_sv_f16_cuda_sm80.cuh"\n'
...
for hd, qkg, dtype_out, causal, lse in product(
        head_dims, qk_quant_grans, dtypes_out, is_causals, return_lses):
    ...
    filename = (
        ...
        f"_o{dtype_out}_causal{bool_to_int(causal)}_lse{bool_to_int(lse)}_fvm{bool_to_int(fuse_v_mean)}.cu"
    )
    ...
    instantiation = (
        ...
        f"{str(causal).lower()}, {str(lse).lower()}, {str(fuse_v_mean).lower()}"
