      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            ...
            SageAttentionSM80Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, float, false, DTypeOut, IS_CAUSAL, RETURN_LSE, false>(
      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            ...
            SageAttentionSM80Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, half, false, DTypeOut, IS_CAUSAL, RETURN_LSE, false>(
              reinterpret_cast<int8_t*>(query.data_ptr()),
              reinterpret_cast<int8_t*>(key.data_ptr()),
              reinterpret_cast<half*>(value.data_ptr()),
              reinterpret_cast<DTypeOut*>(output.data_ptr()),
      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            ...
            SageAttentionSM80Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, float, true, DTypeOut, IS_CAUSAL, RETURN_LSE, false>(
              reinterpret_cast<int8_t*>(query.data_ptr()),
              reinterpret_cast<int8_t*>(key.data_ptr()),
              reinterpret_cast<half*>(value.data_ptr()),
              reinterpret_cast<DTypeOut*>(output.data_ptr()),
      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            ...
            SageAttentionSM80Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, half, false, DTypeOut, IS_CAUSAL, RETURN_LSE, true>(
              reinterpret_cast<int8_t*>(query.data_ptr()),
              reinterpret_cast<int8_t*>(key.data_ptr()),
              reinterpret_cast<half*>(value.data_ptr()),
              reinterpret_cast<DTypeOut*>(output.data_ptr()),
