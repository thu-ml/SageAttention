      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_type, DTypeOut, {
            ...
            SageAttentionSM90Dispatched<CTA_Q, CTA_K, NUM_THREADS, HEAD_DIM, QK_QUANT_GRAN, DTypeOut, IS_CAUSAL, RETURN_LSE, false>(
      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            ...
            SageAttentionSM90Dispatched<CTA_Q, CTA_K, NUM_THREADS, HEAD_DIM, QK_QUANT_GRAN, DTypeOut, IS_CAUSAL, RETURN_LSE, true>(
              reinterpret_cast<int8_t*>(query.data_ptr()),
              reinterpret_cast<int8_t*>(key.data_ptr()),
              reinterpret_cast<__nv_fp8_e4m3*>(value.data_ptr()),
              reinterpret_cast<DTypeOut*>(output.data_ptr()),
