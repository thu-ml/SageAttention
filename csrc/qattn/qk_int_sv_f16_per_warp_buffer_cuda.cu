...
__global__ void qk_int_sv_f16_attn_per_warp_buffer_kernel(int8_t *__restrict__ Q, int8_t *__restrict__ K, half *__restrict__ V, DTypeOut *__restrict__ O, float *__restrict__ Lse,
    ...
    DISPATCH_CAUSAL(is_causal, IS_CAUSAL, {
      DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
        DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
          ...
          auto kernel_func = qk_int_sv_f16_attn_per_warp_buffer_kernel<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, DataType::kInt8, DTypeOut, ComputeUnit::kTensorCore, 
